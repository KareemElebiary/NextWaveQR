...
echo Importing attendee data into Firebase...
"%PYTHON%" import_attendees_firebase.py
set "EXIT_CODE=%ERRORLEVEL%"

echo.
if "%EXIT_CODE%"=="0" (
    echo Firebase attendee sync completed.
) else (
    echo Firebase attendee sync failed with code %EXIT_CODE%.
)
pause
exit /b %EXIT_CODE%
